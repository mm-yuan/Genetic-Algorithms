...
LOCALLOOP=0;      % local loop removal 1or 0
CROSSOVER = 'xov_order';  % 'xalt_edges'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
crossover = uicontrol(ph,'Style','popupmenu', 'String',{'CROSSOVER'}, 'Value',1,'Position',[10 50 130 20],'Callback',@crossover_Callback);
...
set(fh,'Visible','on');
    ...
    function runbutton_Callback(hObject,eventdata)
        ...
        run_ga_modified(x, y, NIND, MAXGEN, NVAR, ELITIST, STOP_PERCENTAGE, PR_CROSS, PR_MUT, CROSSOVER, LOCALLOOP, ah1, ah2, ah3);
        end_run();
    end
